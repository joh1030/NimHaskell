...
dumbPlayerMove :: SticksPerRow -> SticksPerRow
dumbPlayerMove sticksPerRow
	| sticksPerRow !! 0 > 0 = [0, sticksPerRow !! 1, sticksPerRow !! 2]
	| sticksPerRow !! 1 > 0 = [0,0, sticksPerRow !! 2]
	| sticksPerRow !! 2 > 0 = [0,0,0]
...
play sticksPerRow player = do
	...
	-- Computer Player
		...
		let sprAfterCompPlayerMove = dumbPlayerMove sticksPerRow
